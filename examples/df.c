...
PAS A FAIRE
  ...
  remplacer comm collection
  2 reouvrir communication  
...
main (int argc, char *argv[])
{
  ...
  /* } */
  MPI_Bcast(&lsize, 1, MPI_INT, PROC_NULL, MPI_COMM_WORLD);
  ...
  MPI_Scatter(a_io.val, lsize, MPI_FLOAT, a_local.val+1, lsize, MPI_FLOAT, PROC_NULL, MPI_COMM_WORLD);
